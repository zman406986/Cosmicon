...
if "%CURRENT%"=="EN" (
    ...
    set "TARGET_NAME=Chinese / ����"
) else (
    set "CURRENT_NAME=Chinese / ����"
    set "TARGET_NAME=English"
)

echo Current language / ��ǰ����: %CURRENT_NAME%
echo/
echo Switch to / �л�Ϊ: %TARGET_NAME%?
echo/
set /p CONFIRM= [Y/N]:
if /i "!CONFIRM!" neq "Y" (
    echo Cancelled / ��ȡ����
...
echo  �Ѵ� %CURRENT_NAME% �л�Ϊ %TARGET_NAME%
echo ============================================
echo/
pause
