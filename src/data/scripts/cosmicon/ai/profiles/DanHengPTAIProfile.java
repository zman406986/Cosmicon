...
public class DanHengPTAIProfile extends AbstractCharacterAIProfile {
    ...
    protected String getPassiveDescription(List<Integer> selectedValues) {
        return PassiveEvaluator.sumAtLeast(selectedValues, 18) ? Strings.get("character.dan_heng_pt.passive_desc") : "";
    }
