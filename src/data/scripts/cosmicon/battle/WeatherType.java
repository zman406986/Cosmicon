...
public enum WeatherType {
    ...
    SCORCHING_SUN(WeatherCategory.SAFEGUARD, 4),
    ACID_RAIN(WeatherCategory.SAFEGUARD, 4),
    HIGH_TEMPERATURE(WeatherCategory.ATTACK, 4),
    STORM(WeatherCategory.ATTACK, 4),
    MODERATE_SNOW(WeatherCategory.HELP, 4),
    HEAVY_SNOW(WeatherCategory.ATTACK, 4),
    DUST(WeatherCategory.REVERSAL, 4),
    SEA_OF_CLOUDS(WeatherCategory.ATTACK, 6),
    RAINBOW(WeatherCategory.ATTACK, 6),
    DROUGHT(WeatherCategory.REVERSAL, 6),
    LUNISOLAR_LUMINANCE(WeatherCategory.REVERSAL, 6),
    CREPUSCULAR_RAYS(WeatherCategory.ATTACK, 6),
    TEMPORAL_STORM(WeatherCategory.HELP, 6),
